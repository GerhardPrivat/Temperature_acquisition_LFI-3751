...
def readingwriting(timeint, countmax, newstdin, continuous, datalist, flag, settemp, Pvalue, Ivalue, Dvalue, settempflag, PIDflag, Pflag, Iflag, Dflag, OUTPUTflag, OUTPUTOFFflag, OUTPUTONflag):
    ...
    def recordingtemperature1(timeint, countmax, datalist):
        #global timedata_np
        #global tempdata_np
    ...
    def recordingtemperature2(timeint, countmax, datalist):
    ...
    def readtemperature(newstdin):
        ...
        while True:
            ...
            settemp_new = newstdinfile.readline()
    ...
    if (continuous == "n"):
        thread1 = threading.Thread(target=recordingtemperature1, args=(timeint,countmax,datalist))
        ...
        thread1 = threading.Thread(target=recordingtemperature2, args=(timeint,countmax,datalist))
        thread2 = threading.Thread(target=readtemperature, args=(newstdin,))
        thread2.daemon = True
...
if __name__ == "__main__":
    ...
    #    print "Storage array greater than 1GB!"
    #else:
    #    print str(data_np.nbytes/1e6)+"MB storage array and "+str(countmax)+" values.\n"
    ...
    storagepath = "C:\\Users\\labadmin.MPL\\Documents\\Alex\\Measurements\\Temperature_measurements"
